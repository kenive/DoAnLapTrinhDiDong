          ...
          children: [
            Wrap(
              ...
              children: List.generate(prods.datasearch.length, (index){
                return  InkWell(
                   onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (_)=>PageDetail(product: prods.datasearch[index])));
                  },
                  ...
                  child: Column(
                    ...
                    image: DecorationImage(image: AssetImage(prods.datasearch[index].imageUrl),
                    fit: BoxFit.cover,
                    ),
