                  ...
                  children: [
                    ...
                    FlatButton(
                          ...
                          onPressed: () {
                            ...
                            if(txtAddress.text.isNotEmpty&&txtEmail.text.isNotEmpty&&txtName.text.isNotEmpty&&txtPhone.text.isNotEmpty){
                              update();
      ...
      showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text('Bạn có muốn cập nhật thông tin lại không?',),
            actions: [
              TextButton(
                onPressed: (){
