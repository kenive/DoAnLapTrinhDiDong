...
class PageDaHuy extends StatefulWidget {
  const PageDaHuy({Key? key}) : super(key: key);

  @override
  _PageDaHuyState createState() => _PageDaHuyState();
}

class _PageDaHuyState extends State<PageDaHuy> {
  @override
  Widget build(BuildContext context) {
    var lstinvoi = Provider.of<InvoiceProvider>(context, listen: false);
    var id = Provider.of<LoginProvider>(context, listen: false);
    lstinvoi.getInvoice(id.acc!.id, 4);
    return Scaffold(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  const Text('Địa chỉ: '),
                                  Text(
                                      lstinvoi.lstInvoise[index].addresshoping),
                                ],
                              ),
                              const SizedBox(
                                height: 10,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      '${lstinvoi.lstInvoise[index].total} VNĐ'),
                                ],
                              ),
                              const SizedBox(
                                height: 10,
                              ...
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceEvenly,
                                children: [
                                  const Text('Nhấp vào để xem chi tiết hóa đơn',
                                  ...
                                  ElevatedButton(
                                      ...
                                      onPressed: () {
                                        //lstinvoi.updateStatus(lstinvoi.lstInvoise[index].id, 1);
                                        lstinvoi.getItem(
                                            lstinvoi.lstInvoise[index].id);
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          content: Text('Sản phẩm chọn mua đã được thêm vào giỏ hàng'),
                                        ));
                                      },
